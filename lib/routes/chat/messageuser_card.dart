...
class MessageUserCard extends StatelessWidget {
  ...
  const MessageUserCard({Key? key,required this.analytics, required this.observer, required this.username, required this.profilePic, required this.userId}) : super(key: key);
